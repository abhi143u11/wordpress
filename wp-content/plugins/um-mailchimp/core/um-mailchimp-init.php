	...
	***/
	function init() {
		...
		if( ! class_exists('UM_MailChimp_V3') ){
			require_once um_mailchimp_path . 'lib/um-mailchimp-api-v3.php';
		}

		if( ! class_exists('UM_MailChimp_Batch') ){
			require_once um_mailchimp_path . 'lib/um-mailchimp-batch.php';
		}
		
		require_once um_mailchimp_path . 'lib/um-mailchimp-api.php';
		require_once um_mailchimp_path . 'admin/core/um-mailchimp-ajax.php';
