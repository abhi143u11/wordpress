<?php
/*
Template Name: All Specifications
*/


$args = array('post_type' => 'specification', 'post_status' => 'publish','posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC');
$specs = new WP_Query($args);
